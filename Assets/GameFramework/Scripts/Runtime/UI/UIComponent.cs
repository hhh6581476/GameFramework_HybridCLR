...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        public UIGroupHelperBase uiGroupHelper;
        ...
        public bool AddUIGroup(string uiGroupName, int depth)
        {
            ...
            {
                uiGroupHelper = GameObject.FindObjectOfType<DefaultUIGroupHelper>();
            }
            ...
            //Canvas canvas = uiGroupHelper.gameObject.AddComponent<Canvas>();
            //canvas.renderMode = RenderMode.ScreenSpaceOverlay;
            //CanvasScaler canvasScaler = uiGroupHelper.gameObject.AddComponent<CanvasScaler>();
            //canvasScaler.uiScaleMode = CanvasScaler.ScaleMode.ScaleWithScreenSize;
            //uiGroupHelper.gameObject.AddComponent<GraphicRaycaster>();
